...
| --- | --- | --- | --- | --- | --- |
| 1.5 | 2026-01-22 | 2796<sub>(+114) | 3062<sub>(+116) | 3137<sub>(+151) |  |
...
xychart-beta
  ...
  line "STC (8.0+0.08s)" [2682, 2796]
  line "STC (8.0+0.08s)" [2682, 2796]
  line "LTC (60.0+0.60s)" [2946, 3062]
  line "VLTC (2m24s+1.12s)" [2986, 3137]
  line "VLTC (2m24s+1.12s)" [2986, 3137]
```
